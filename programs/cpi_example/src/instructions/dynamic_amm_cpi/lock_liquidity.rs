...
pub fn handle_lock_liquidity(ctx: Context<LockLiquidity>, allocations: [u16; 2]) -> Result<()> {
...
// #[derive(Accounts)]
// pub struct LockLiquidityPdaCreator<'info> {
//     /// CHECK: Pool account (PDA)
//     #[account(
//         mut,
//         has_one = lp_mint,
...
//     ctx: Context<LockLiquidityPdaCreator>,
//     allocations: [u16; 2],
// ) -> Result<()> {
//     let total_bps: u32 = allocations
//         .iter()
